...
class CreateActivity : AppCompatActivity() {
    companion object {
        ...
        private const val MIN_NAME_GAME_LENGTH =3
        private const val MAX_NAME_GAME_LENGTH =3
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imagePickerAdapter = ImagePickerAdapter(this, chosenImageUris, boardSize,object: ImagePickerAdapter.ImageClickListener {
            override fun onPlaceholderClicker() {
                if(isPermissionGranted(this@CreateActivity, READ_IMAGES_PERMISSION)){
                     launchIntentForPhotos()
                }else{
                    requestPermission(this@CreateActivity, READ_IMAGES_PERMISSION,
        ...
        etGameName.filters = arrayOf(InputFilter.LengthFilter(MAX_NAME_GAME_LENGTH))
    ...
    override fun onRequestPermissionsResult(
        ...
        if(requestCode == READ_EXTERNAL_PHOTOS_CODE){
            if(grantResults.isNotEmpty()&&grantResults[0] == PackageManager.PERMISSION_GRANTED){
                ...
                Toast.makeText(this,"In order to create custom game, you need to provide access to your photos",Toast.LENGTH_LONG)
            }
        }
    ...
    private fun shouldEnableSaveButton(): Boolean {
        ...
        if (etGameName.text.isBlank() || etGameName.text.length < MIN_NAME_GAME_LENGTH) {
            return false
        }
        return true
    }
